...
使用示例:
  ...
  python %(prog)s /path/to/file1.pt /path/to/file2.pt
    ...
    parser.add_argument('files', nargs='*',  # 改为 '*' 允许0个或多个参数
                        default=[
                            "/home/bohao/LuvRobot/Y1_1Pace/data/Atom3motors/raw_pt/260117_chrip_20s_3motors_aligned.pt",
                            "/home/bohao/LuvRobot/Y1_1Pace/data/sim_data/260117_chrip_20s_3motors_aligned_sim_output.pt"
                        ],
